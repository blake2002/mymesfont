...
;
exports.ruleArray = {
    min: (value, parameter) => parseInt(value, null) >= parameter,
    max: (value, parameter) => parseInt(value, null) <= parameter,
...
function addRule(ruleObj) {
    ...
    if (ruleObj.regExp) {
        exports.regExpArray[ruleObj.key] = ruleObj.rule;
    }
    if (ruleObj.rule) {
        exports.ruleArray[ruleObj.key] = ruleObj.rule;
    }
    if (ruleObj.replace) {
        exports.replaceArray[ruleObj.key] = ruleObj.replace;
    }
}
