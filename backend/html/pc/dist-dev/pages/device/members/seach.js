define("pages/device/members/seach.js",function(require, exports, module) {
"use strict";
...
const seach_1 = require("../device/seach");
/**
 * 设备搜索
 *
 * @export
 ...
 */
class DeviceSeach extends seach_1.default {
    constructor() {
        super(...arguments);
        this.title = '人员';
        this.listUrl = '/device/members/index';
    }
    ajaxSeach() {
    ...
    render() {
        ...
        return React.createElement("section", { className: 'h100 page-device-seach' },
            React.createElement(_main_1.MainLeft, { type: 'relationMember' },
